<div class="modal fade" id="entries-add-unconfirmed-modal" tabindex="-1" role="dialog" aria-labelledby="entries-add-unconfirmed-modalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="entries-add-unconfirmed-modalLabel">{{ !empty($addEntryModalTitle) ? $addEntryModalTitle.' &rsaquo;  Add Entry' : 'Add Account Entry' }}</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<form action="" id="form-entries-add-unconfirmed" method="post">
					{{ csrf_field() }}
			...
			<div class="modal-footer">
				...
				<button type="submit"  name="action" value="save_entry" form="form-entries-add-unconfirmed" class="btn btn-primary">Save Entry</button>
			</div>
		</div>
	</div>
</div>
